...
/*   Updated: 2022/12/26 16:55:16 by ataji            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ShrubberyCreationForm::executer(Bureaucrat const& B) const{
    std::ofstream OF;
    if (B.getGrade() <= AForm::getExecGrade() && (AForm::getSigned() == true)){
